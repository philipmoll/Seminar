...
public class Main {
	...
	private final static int nriterations = 300;

	private final static int nrtrainstoadd = 0;

	private final static int nrpercentages = 10;
	private final static double increase = .05;
	private static int activitytoadd = 2; //1: washing, 2: inspprob2, 3; repprob
	...
	public static void main(String args[])
	{
		...
		try {
			...
			for (int xx = 0; xx<sizearrays; xx++){
				...
				System.out.println("INSP PROBABILITY: "+inspectionprobabilities[xx]);
			...
			//TODO: HALLO HIER MOET JE ZIJN
			
			System.out.println();
			System.out.println("RESULTS:");
			for (int yy = 0; yy<inspectionprobabilities.length; yy++){
				System.out.println("INSP PROBABILITY: "+inspectionprobabilities[yy]);
