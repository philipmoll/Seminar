...
public class ParkingTest {
	...
	public void setUp() {
		try {
			track1 = new Track("track1", 40, 1, 0, 0, 0, 0, 20);
			...
			event1 = new Event(fblock1, 0, 1, fblock1.getArrivalTimeInteger(), endtime12, 0, 1, event2);
			...
			event3 = new Event(fblock1, 0, 0, starttime34, fblock1.getDepartureTimeInteger(), event2.getSideend(), 0, event4);
			...
			event5 = new Event(fblock2, 0, 1, fblock2.getArrivalTimeInteger(), endtime56, 0, 0, event6);
			...
			event7 = new Event(fblock2, 0, 0, starttime78, fblock2.getDepartureTimeInteger(), event6.getSideend(), 1, event8);
...
//			}
	...
	public void testSortEvents() {
		...
		assertEquals(event2,park1.getTimeline().get(2));
		assertEquals(event6,park1.getTimeline().get(3));
